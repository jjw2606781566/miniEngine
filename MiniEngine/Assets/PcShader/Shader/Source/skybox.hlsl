...
{
	// ����Ļλ��ת��Ϊ [-1, 1] ��Χ��NDC����
    float2 uv = positionCS.xy / ScreenParams.xy; // �����ڲο�
    float4 ndc = float4(
        uv * 2.0f - 1.0f,
        1.0f,
        1.0f
    ...
    // ʹ�� ViewProj ��������NDC���귴�� view-space ����
    float4 viewDirH = mul(ndc, ViewProj_I);
    float3 viewDir = normalize(viewDirH.xyz);

    // 1. ������ջ�����ɫ����ƽ�߽��䣩
    float horizon = smoothstep(-0.1, 0.1, viewDir.y); // ��ƽ�߹���
    ...
    float sunGlow = pow(sunDot, 32.0) * mainLightColor.a; // ����ǿ��
