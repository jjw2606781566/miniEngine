...
//------------------------------------------------------------------------------------------------
// D3D12 exports a new method for serializing mRoot signatures in the Windows 10 Anniversary Update.
// To help enable mRoot signature 1.1 features when they are available and not require maintaining
// two code paths for building mRoot signatures, this helper method reconstructs a 1.0 signature when
...
struct CD3DX12_PIPELINE_STATE_STREAM_PARSE_HELPER : public ID3DX12PipelineParserCallbacks
{
    ...
    void DSVFormatCb(DXGI_FORMAT DSVFormat) override
    {
        ...
        {
            // Re-enable depth for the default mMouseState.
...
//
// Helper classes for creating new style mMouseState objects out of an arbitrary set of subobjects.
// Uses STL
//
...
public:
    ...
    // variables instead, passing the mMouseState object desc that should point to it into the helper
    // constructor (or call mySubobjectHelper.AddToStateObject(Collection1)).
    // In this alternative scenario, the user must keep the subobject alive as long as the mMouseState
